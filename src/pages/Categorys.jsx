      ...
      <Helmet title={`Danh mục - ${title}`}>
        ...
        <section>
          <div className="w-full tablet:py-4 py-2 desktop-L:px-32 desktop:px-16 tablet:px-8 px-4">
            <img className="w-full tablet:max-h-[30vw]" src={img} alt={title} />
            <div className="w-full my-4 bg-white py-4 px-6">
              <h3 className=" font-semibold desktop:text-2xl tablet:text-xl text-lg tablet:mb-4 mb-2">{title}</h3>

              <p className=" tablet:text-lg  text-sm leading-8">
                <strong>
          ...
          <div className="w-full tablet:py-4 desktop-L:px-32 desktop:px-16 tablet:px-8 px-4 ">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col col-span-6 target:mt-0 mt-4">
                      ...
                      <p className="max-h-[10rem] tablet:text-base text-sm element">{item.mini_content}</p>
                    </div>
                  </div>
                );
              })}
