...
const Footer = () => {
  ...
  return (
    <footer>
      <div className="w-screen bg-yellow-second pt-12 tablet:px-16 px-4">
        <div className="w-full tablet:px-8 px-4 py-8 border-t-2 border-red-primary grid desktop:grid-cols-3 grid-cols-1">
          <div>
            <div
              className={
                open
                  ? "grid grid-cols-1 desktop:gap-6 gap-0 bg-transparent -m-4 desktop:m-0 group/navfooter active"
                  : "grid grid-cols-1 desktop:gap-6 gap-0 bg-transparent -m-4 desktop:m-0 group/navfooter"
              }
            >
              <h3
                onClick={() => {
              ...
              <div className="grid grid-cols-1 desktop:gap-6 gap-0 ] desktop:max-h-[400px] max-h-0 group-[.active]/navfooter:max-h-[400px] overflow-hidden transition-all duration-500 ease-in-out desktop-L:mr-4">
                {nav.map((item, index) => {
                  return (
                    <a
                      key={index}
          ...
          <div className=" col-span-2 desktop:border-l-2 border-red-primary border-dashed grid grid-cols-1 desktop-L:gap-2 gap-3 desktop-L:pl-16 desktop:pl-8 desktop:mt-0 mt-8">
            <div>
            ...
            <div className=" tablet:flex grid grid-cols-1 items-center mt-2">
              <a href="/">
                <img
              ...
              <div className="w-fit h-full grid grid-cols-4 tablet:gap-6 gap-4 desktop-L:ml-16 tablet:ml-8 m-auto tablet:mt-0 mt-4 items-center">
                <a
                  href="/"
                  className="desktop-L:w-16 desktop-L:h-16 w-12 h-12 border border-black-primary flex items-center justify-center transition-all duration-300 ease-in-out hover:bg-white-primary hover:-translate-y-2"
                >
                  <FaFacebookF size={30} />
                </a>
                <a
